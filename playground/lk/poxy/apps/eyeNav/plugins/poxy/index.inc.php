...
<head>
  <title>PHProxy</title>
  <link rel="stylesheet" type="text/css" href="index.php?version=EXTERN_CACHE_VERSION&amp;theme=1&amp;extern=css/apps/eyeNav/poxy.css" title="Default Theme" media="all" />
</head>
...
?>
  <form method="post" action="<?php echo $GLOBALS['_script_url'] /* $_SERVER['PHP_SELF'] */ ?>">
    <ul id="form">
