...
namespace eyeSync
{
    ...
    public class eyeOS
    {
        ...
        public string loadFile(string file)
        {
            ...
            string s = connect.service_vfs_readFile(Config.User, Config.Password, a);
            string[] x = s.Split(new string[] { "<?xml" }, StringSplitOptions.None);
        ...
        public bool downloadFile(string fileOnline, string fileOffline)
        {
            ...
            try
            {
                ...
                System.IO.StreamWriter w = new System.IO.StreamWriter(fileOffline, false, Encoding.Default);
                w.Write(s);
                w.Close();
                createSyncFile(fileOffline);
                return true;
