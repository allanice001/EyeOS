...
namespace eyeSync
{
    ...
    public interface Ieyeos : IXmlRpcProxy
    {
        ...
        [XmlRpcMethod("service.vfs.getFileBinary")]
        string service_vfs_getFileBinary(string username, string password, Array a);

        /// <summary>
        /// Method to get every file in a folder
        /// </summary>
        /// <param name="username">The username</param>
        /// <param name="password">The password of the user above</param>
        /// <param name="a">A array containing the folderpath</param>
        /// <returns>Every file in the specified fodler and its subfolders</returns>
        [XmlRpcMethod("service.vfs.getFolderList")]
        string[] service_vfs_getFolderList(string username, string password, Array a);
