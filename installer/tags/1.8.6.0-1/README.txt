...
What's new in eyeOS 1.8.6.0-1
	* [CHECKED] This release does not support PHP 5.3.0, yet.
	* [FIXED] The eyeOS updater was broken.
	* [FIXED] The iPhone version was not installed successfully.
	* [FIXED] The Readme was not updated.

What's new in eyeOS 1.8.6.0
	* [FEATURE] New eyeMail introduced.
	* [FEATURE] New eyeProcess introduced.
	* [FEATURE] New iPhone version introduced.
	* [FEATURE] New eyePaste, eyeRename and moveDrag introduced. (Showing a dialog to replace or rename an element while copying, moving or renaming)
	* [REWRITE] Message boxes rewritten. (so they do not overlap any longer)
	* [FIX] Speed up many system functions on the clients side.
	* [FEATURE] Possibility to send messages to groups. (disabled for default)
	* [FIX] Restoring files is working with the virtual and with the real vfs module now.
