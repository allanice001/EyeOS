...
What's new in eyeOS 1.8.0.3
	* eyeDesk now checks if the desktop folder really exists
	* Added new parameter to serialize ProgressBar widgets
	* Updated eyeFeeds to version 1.2-2
	* Updated eyeFTP to version 3.2.1-1
	* Improved Office support
	* Improved tabs in Internet Explorer 6
	* Fixed empty requests problem
	* Fixed changing another user's language
	* Fixed problems with eyeContacts
	* Fixed retrocompatibility of the um ufnction retriveUser
