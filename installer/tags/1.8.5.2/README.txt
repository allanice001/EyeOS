...
What's new in eyeOS 1.8.5.2
	* [UPDATED] TinyMCE to its latest version
	* [REVERTED] Flash property wmode, which caused problems with some Firefox installations
	* [FIXED] saving documents with eyeDocs
	* [FIXED] problems with some servers and infinite loops (especially QNAP devices)
