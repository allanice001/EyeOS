...
What's new in eyeOS 1.8.5.1
	* [ADDED] missing methods to some widgets
	* [UPDATED] TinyMCE to its latest version
	* [UPDATED] soundmanager2 to version 2.95
	* [CHANGED] Rewrote eyeFiles' history functions for the Next and Back buttons
	* [CHANGED] eyeControl loads the acocunts page after changing the password
	* [CHANGED] eyeControl tells the user to remove the browser's cache after changing the theme now
	* [FIXED] creating and editing maintainers
	* [FIXED] eyeAddressBook is fully translatable and themable now
	* [FIXED] eyeDialog problems
	* [FIXED] eyeFiles creates more smooth thumbnails now
	* [FIXED] eyeMedia problems
	* [FIXED] loading applications with different names with eyeApps
	* [FIXED] problems with moving a window containing a flash element into the background
	* [FIXED] showing errors after uploading files with the simple upload tab
	* [FIXED] the integration of TinyMCE
	* [FIXED] translating eyeChess
	* [FIXED] translating eyeDockText menu categories
	* [FIXED] translating eyeShare
	* [FIXED] uninstalling eyeOS now also removes the "browser" directory
	* [FIXED] using "Cancel" button in eyeFeeds
