...
What's new in eyeOS 1.8.5.3
	* [REWROTE] eyeDocs to be sure, that no data gets lost
	* [FIXED] cookieEnabled check, which didn't work correctly in most browsers
	* [FIXED] Contextmenus, which don't move out of the visible screen any longer
	* [FIXED] the Tree widget, which caused problems in IE
	* [FIXED] the description label for eyeControl sections
	* [FIXED] problems with too long eyeControl section names
	* [REMOVED] not needed gif images for IE6 from the default theme
