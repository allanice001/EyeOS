...
function installEyeOS(){
	...
	lib_eyeCompress_extractFile(INSTALL_DIR);
...
function lib_eyeCompress_extractFile($params){
	...
	$archExtractor->extractArchive(INSTALL_PACKAGE,$dirToExtract);
}
...
//
// Description :
//   See readme.txt (English & Francais) and http://www.phpconcept.net
//
// Warning :
