...
global $ICL_PORT;
$ICL_PORT = 995;
//print_r('antes de la conn');

$conn = iil_pop::iil_Connect('pop.correo.yahoo.es', 'eyeosmail@yahoo.es', '');
//$conn = iil_pop::iil_Connect('pop.gmail.com:995', 'eyeosmail@gmail.com', '');

//print_r('despues de la conn');
...
//print_r(iil_pop::iil_C_FetchStructureString($conn, $folder, $id));
//print_r($conn);
...
//print_r("estructura_str: " . $structure_str . '<br>');
$structure=iml_GetRawStructureArray($structure_str);
//var_dump("estructura: " . $structure . '<br>');
