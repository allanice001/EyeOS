...
qx.Class.define('desktop.WidgetManager', {
    ...
    members: {
        loadWidgets: function(checknum) {
			desktop.actionManager.getInstance().setChecknum(checknum);
            this.setWidgets([]);
        ...
        processMenu: function(menu) {
			...
			omenu.addListener('appear', function(e) {
				...
				if(opener instanceof qx.ui.basic.Atom &&
				...
				} else if (!(opener instanceof qx.ui.basic.Atom)) {
        ...
        createDesktopWidgetAlone: function(checknum, files) {
            ...
            this.widgetContainer.addListener('mousemove', function(e) {
                if(this.selecting) {
                    ...
                    for(var i in childrens) {
                        if(childrens[i] instanceof qx.ui.basic.Atom) {
            ...
            this.widgetContainer.addListener('drop', function(e) {
                ...
                //TODO24 joca: extremly huge coupling here, files and desktop should not know each other!!!
                if(eyeos.files && item instanceof eyeos.files.IconViewItem) {
					...
					if(item instanceof qx.ui.menu.Button) {
						//create shortcut
...
//                    domele.childNodes[0].style.fontSize = '12px';
            ...
            if(file.meta && file.meta.iconPositionY && file.meta.iconPositionX) {
                ...
                atom.setUserBounds(file.meta.iconPositionX, file.meta.iconPositionY, 76, 82);
