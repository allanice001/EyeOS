...
qx.Class.define('eyeos.spreadsheet.columnmodel.Basic', {
	...
	statics: {
		...
		DEFAULT_DATA_RENDERER   : eyeos.spreadsheet.cellrenderer.Default,
	...
	members: {
		...
		init: function(colCount, param) {
			...
			for (var i = 0; i < colCount; ++i) {
				//if (i != 1) {
					this.setDataCellRenderer(i, new eyeos.spreadsheet.cellrenderer.Default(this._table.getTableModel(), this._table));
				//} else {
