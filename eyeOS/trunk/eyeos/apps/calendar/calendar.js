...
//			//DEBUG - TOGGLE LOCALE
//			var tmpButton = new qx.ui.toolbar.Button('Toggle Locale', 'index.php?extern=images/16x16/categories/applications-development-translation.png').set({
//				iconPosition: 'top'
//			});
//			tmpButton.addListener('execute', function(e) {
//				if (qx.locale.Manager.getInstance().getLocale() == 'fr_FR') {
//					qx.locale.Manager.getInstance().setLocale('en_US');
//				} else {
//					qx.locale.Manager.getInstance().setLocale('fr_FR');
//				}
//			});
//			this.__toolBar.add(tmpButton);
		...
		_buildWorkArea_leftPane: function() {
			...
			blockCalendar.setPeriodMode(eyeos.calendar.Constants.PERIOD_MODE_DAY);		//TODO default mode will be configurable by the user
		...
		_buildWorkArea_rightPane: function() {
			...
			firstContainer.add(currentPeriodLabel, {flex: 1, width: '30%'});
			...
			// Spacer (right)
			firstContainer.add(new qx.ui.core.Spacer(), {flex: 1, width: '20%'});
