 ...
 *		'type' => "Groups_InvitedUsersReceiver"
 *		'eventData' => array (
...
class InvitedUsersReceiverEvent implements ISimpleEventHandler {
	/**
        ...
        switch ($event->getAnswer()) {
            case 'Confirm':
                try {
                    ...
                    $assignation->setRole(WorkgroupConstants::ROLE_VIEWER); // what about if it's not viewer ????
