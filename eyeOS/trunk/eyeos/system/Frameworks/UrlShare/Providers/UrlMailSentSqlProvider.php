...
class UrlMailSentSqlProvider implements IUrlMailSentProvider {
	...
	private function getDao() {
		if (!isset(self::$dao)) {
			try {
				$dbHandler = StorageManager::getInstance()->getHandler('SQL/EyeosDAO');
			} catch (Exception $e) {
