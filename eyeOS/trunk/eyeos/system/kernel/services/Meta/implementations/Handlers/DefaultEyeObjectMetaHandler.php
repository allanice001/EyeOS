...
class DefaultEyeObjectMetaHandler implements ISearchableMetaDataHandler {
	...
	public static function getProvider($metaDataClass) {
		if(self::$Provider === null) {
			self::$Provider = new PDOMetaProvider((string) $metaDataClass, array(
							PDOMetaProvider::PARAM_CONNECTIONSTRING => SQL_CONNECTIONSTRING,
							PDOMetaProvider::PARAM_TABLENAME => self::METADATA_TABLE_NAME,
							PDOMetaProvider::PARAM_USERNAME => SQL_USERNAME,
							PDOMetaProvider::PARAM_PASSWORD => SQL_PASSWORD
			));
		}
