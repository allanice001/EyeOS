...
qx.Class.define('eyeos.dashboard.Board', {
	...
	'construct': function (containers) {
		...
		this._transparentLayer = new qx.ui.container.Composite(new qx.ui.layout.VBox(0), {'droppable': false});
		this._transparentLayer.add(this._dashboardLayer, {'flex': 1});
		this.add(this._transparentLayer, {'flex': 1});
	...
	'members': {
		...
		'addContainer': function (element) {
			this._dashboardLayer.add(element, {'flex': 1});
