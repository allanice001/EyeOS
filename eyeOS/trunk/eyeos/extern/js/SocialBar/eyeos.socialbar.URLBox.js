...
qx.Class.define('eyeos.socialbar.URLBox', {
	...
	members: {
		...
		_createURL: function() {
			...
			eyeos.callMessage(this.getChecknum(), '__UrlShare_createURL', {path: shareds[0].getObject()}, function (results){
				var URLWindow = new eyeos.socialbar.URLWindow(this.getChecknum(), results, 1, this);
			}, this);
		},
