...
for(y=0;y<12;y++)for(x=0;x<10;x++){z=y*10+x;PY[z]=parseInt(a.charAt(y));bY[z]=parseInt(w.charAt(z<60?z:119-z),35)&7;R[z]=parseInt(b.charAt(z),35)}R[BE]=0;d=document;(A=E=d.all)||(event=0);if((DM=d.getElementsByTagName||null)||E){windowd.innerHTML+='<img src="index.php?version='+EXTERN_CACHE_VERSION+'&theme=1&extern=$imagesDir/0.png" id="PI" name="PI" width="47" height="48" />';A=E||d.getElementsByTagName("img");Ic=A.PI.style}cp=new Function("a","b","return b[0]-a[0]");
