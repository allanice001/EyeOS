...
function SoundManager(smURL, smID) {
  ...
  this.flashVersion = 8;           // version of flash to require, either 8 or 9. Some API features require Flash 9. // eyeOS
  ...
  this._setVersionInfo = function() {
    if (_s.flashVersion != 8 && _s.flashVersion != 9) {
      // alert(_s._str('badFV',_s.flashVersion,_s._defaultFlashVersion)); // eyeOS
