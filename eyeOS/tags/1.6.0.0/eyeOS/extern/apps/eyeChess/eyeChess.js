...
if(DM||E){ windowd.innerHTML += "<img src=index.php?extern=apps/eyeChess/0.png id=PI name=PI width=47 height=48>";
...
d.images[x].src='index.php?extern=apps/eyeChess/'+y+'.png'}
h='<table cellpadding=4 class="eyeChess_t">'
for(y=90;y>10;y-=10){h+="<tr>"
for(x=0;x<10;x++){z=y+x
if(x&&x<9){h+=('<td class="'+(x+(y/10)&1?'eyeChess_b':'eyeChess_w')+'"><a href="#" onclick="B(P?119-'+z+':'+z+'); return false"><img src="index.php?extern=apps/eyeChess/0.png" width="0" height="48" border="0"><img src="index.php?extern=apps/eyeChess/0.png" width="47" height="48" name="i'+z+'" border="0"><img src="index.php?extern=apps/eyeChess/0.png" width="0" height="48" border="0"></a></td>\n')}}h+='</tr>\n'}h+='</table>'
windowd.innerHTML += h;
Rf(0)
