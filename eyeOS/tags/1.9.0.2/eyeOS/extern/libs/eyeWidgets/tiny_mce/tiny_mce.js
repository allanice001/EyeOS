function smoothScale(val,id,ori) { // eyeOS
...
function disableEdShadow(id) { // eyeOS
...
function enableShadow(id) { // eyeOS
	...
	obj.style.width='8px';
	obj.style.backgroundImage = 'url(index.php/extern/externVersion/1/externPath/libs/eyeWidgets/tiny_mce/themes/advanced/img/left_sh.png)';
	...
	lcobj.style.backgroundImage = 'url(index.php/extern/externVersion/1/externPath/libs/eyeWidgets/tiny_mce/themes/advanced/img/cornerleft_sh.png)';
	...
	var obj = document.createElement('div');
	obj.style.width='8px';
	obj.style.backgroundImage = 'url(index.php/extern/externVersion/1/externPath/libs/eyeWidgets/tiny_mce/themes/advanced/img/right_sh.png)';
	obj.style.height = xHeight(ifr)-6+'px'; // 13 = size of the corner
	obj.style.top = '109px';
	obj.style.position = 'absolute';
	...
	lcobj.style.width = '14px';
	lcobj.style.height = '14px';
	lcobj.style.backgroundImage = 'url(index.php/extern/externVersion/1/externPath/libs/eyeWidgets/tiny_mce/themes/advanced/img/cornerright_sh.png)';
	lcobj.style.position = 'absolute';
	...
	tobj.style.backgroundImage = 'url(index.php/extern/externVersion/1/externPath/libs/eyeWidgets/tiny_mce/themes/advanced/img/top_sh.png)';

	ifr_father.appendChild(tobj);
}

function disableShadow(id) {} // eyeOS
...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		...
		toAbsolute : function(u, nh) { // eyeOS
			return tinyMCEPreInit.base + '/' + u;
		},

		toAbsolute_ : function(u, nh) { // eyeOS
...
(function(tinymce) {
	...
	tinymce.create('static tinymce.EditorManager', {
		...
		preInit : function() {
			...
			tinymce.baseURL = new tinymce.util.URI(tinymce.documentBaseURL).toAbsolute_(tinymce.baseURL); // eyeOS
...
*/
		...
		ScalePage : function(val, id) { // eyeOS
			var obj = document.getElementById(id);
			var newSize = parseInt(650 / 100 * val);
			disableEdShadow(id);
			setTimeout("smoothScale("+newSize+",'"+id+"',"+xWidth(obj)+");",10);
		},
		
		SelectZoom : function(ui, val) { // eyeOS
			var t = this, ed = t.editor, d = ed.getDoc();
			//val has the zoom level
			this.ScalePage(val,ed.id+'_ifr');
		},
