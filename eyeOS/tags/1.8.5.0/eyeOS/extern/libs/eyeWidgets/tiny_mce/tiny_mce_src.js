function smoothScale(val,id,ori) {
...
*/
		...
		//jcarlosn: new function to handle the zoom level select.
		SelectZoom : function(ui, val) {
			var t = this, ed = t.editor, d = ed.getDoc();
